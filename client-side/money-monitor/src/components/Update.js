...
class Update extends React.Component {
    ...
    componentDidMount() {
        this.setState({
            ...
            description: this.props.eachCost.description,
            amount: this.props.eachCost.amount,
    ...
    componentWillReceiveProps(nextProps){
        this.setState({
            ...
            description: nextProps.eachCost.description,
    ...
    update(e) {
        ...
        axios.post('http://localhost:8080/cost', entry).then((res) => {
            e.setState({
